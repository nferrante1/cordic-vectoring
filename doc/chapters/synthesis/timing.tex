...
and the \standout{slack} both for the clock period and timing are positive, this
...
The \standout{Max Delay Path} is mostly determined by the routing delay as we
...
\begin{Verbatim}[fontsize=\footnotesize,xleftmargin=-3.6cm]
